...
public enum ExtendedHand {
    ...
    public boolean isSpellBook() {
        return this == ARS_SPELL_BOOK;
    }

    public boolean isCurios() {
        return this == ARS_CURIOS_SLOT_1 || this == ARS_CURIOS_SLOT_2 || this == ARS_CURIOS_SLOT_3 || this == ARS_CURIOS_SLOT_4 || this == ARS_SPELL_BOOK;
    }
    ...
    public String getSlotName() {
        return switch (this) {
            ...
            case ARS_SPELL_BOOK -> "ars_spell_book";
            default -> this.name();
        };
    }
